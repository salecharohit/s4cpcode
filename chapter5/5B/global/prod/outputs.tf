...
output "assume_k8s_admin_role_without_mfa_arn" {
  value = module.assume_k8s_admin_role_without_mfa.role_arn
}

output "assume_k8s_admin_role_without_mfa_name" {
  value = module.assume_k8s_admin_role_without_mfa.role_name
}

output "assume_k8s_developer_role_without_mfa_arn" {
  value = module.assume_k8s_developer_role_without_mfa.role_arn
}

output "assume_k8s_developer_role_without_mfa_name" {
  value = module.assume_k8s_developer_role_without_mfa.role_name
}